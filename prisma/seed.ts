...
async function main() {
  ...
  await (prisma.systemSettings.upsert as any)({
    where: { id: 'default' },
    update: {
      siteName: 'Fashion City India Ltd',
      siteDescription: 'Luxury Fashion E-commerce',
      contactEmail: 'fashioncityinidia18@gmail.com',
      contactPhone: '+91 96015 11596',
      sellerName: 'Fashion City India Ltd',
      sellerContactNumber: '+91 96015 11596',
      sellerLegalName: 'Fashion City India Ltd',
